...
contract CampaignFactory{
    ...
    function createCampaign  (string memory campaignTitle, uint requiredCampaignAmount,string memory imageURI,string memory category, string memory storyURI) public {
...
contract Campaign{
    ...
    constructor(string memory campaignTitle, uint requiredCampaignAmount,string memory imageURI, string memory storyURI){
        title=campaignTitle;
